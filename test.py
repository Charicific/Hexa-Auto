...
legendary_poks = ["Mewtwo", "Yveltal", "Xerneas"]

regular_poks_repeat = ["Aerodactyl", "Lopunny", "Blastoise", "Charizard", "Alakazam", "Gardevoir", "Gallade", "Absol", "Manectric", "Gyarados", "Altaria", "Greninja", "Houndoom", "Gengar", "Hawlucha", "Salamence", "Ampharos"]

regular_ball = ["Charmander", "Ralts", "Squirtle", "Kirlia", "Goomy", "Abra", "Braixen", "Fennekin", "Floette", "Litwick", "Lampent", "Starly", "Gible", "Magikarp", "Helioptile", "Phantump", "Flabebe", "Electrike", "Pumpkaboo", "Shellder", "Skorupi","Golett", "Axew", "Timburr", "Gurdurr", "Litleo"]
        ...
        async with self.client:
            ...
            if shiny_found:
                ...
                try:
                    ...
                    await asyncio.sleep(e.seconds)
                    await self.client.send_message('@HeXamonbot', '/hunt')
                    print('Sent /hunt command after flood wait')
